...
INSERT INTO `migration` VALUES ('m000000_000000_base',1628945498),('m210814_125006_create_user_table',1628945500),('m210814_125322_create_task_table',1628945760);
...
CREATE TABLE `task` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKTRACUSER` (`user_id`),
  CONSTRAINT `FKTRACUSER` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2021-08-20 15:53:05
